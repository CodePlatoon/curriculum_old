...
### Github Pages
Getting a static site up and running on [Github Pages](https://pages.github.com/) is fairly simple.  When we get to React, you can also host a React application, but the process is a bit more complicated.
