...
Next, create an `api` directory and inside the `src` directory create a `UserAPI.js` file that will have our functions that will handle our API requests to our Django backend.
