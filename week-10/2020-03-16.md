...
A completed copy of today's code can be found [here in this repo](https://github.com/kiloplatoon/django-complete-wine-api).

## Challenges
* First, go over this tutorial yourself
* [Schools API](https://github.com/kiloplatoon/school-api)
