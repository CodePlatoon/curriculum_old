...
You can also create a Super User for you Heroku App by running `heroku run python manage.py createsuperuser`. 

A completed copy of today's code can be found [here in this repo](https://github.com/papaplatoon/django-wine-api-completed).

## External Resources
- [Working With JSON Data in Python](https://realpython.com/python-json/)
- [JSON python module](https://docs.python.org/3/library/json.html)
- [Django Rest Framework](https://www.django-rest-framework.org/)
- [Wine API Tutorial using Django Rest Framework](https://github.com/papaplatoon/django-wine-api-drf)
