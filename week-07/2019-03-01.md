...
Go to https://www.heroku.com/ and create a new account. It's free. Once you are logged into your dashboard, click the link to create a new app. Give the app a name and click 'Create App'. Heroku has pretty straight forward instructions on how to proceed. You can just copy and paste the commands it lists if you choose.
