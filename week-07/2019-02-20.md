...
```
Run through your setup, log in, and create 2-3 blog posts. It's super easy to CRUD blog posts as a super administrator and sometimes, this is all that you need. We'll create forms later to CRUD blog posts without being a super administrator (and not cheating).
...
- [Cars and Manufacturers](https://github.com/hotelplatoon/django_cars_and_manufacturers)
- [Beer Reviews](https://github.com/hotelplatoon/django-beer-ratings)