...
LOGIN_REDIRECT_URL = '/'
```
**Note:** If you're using Django version 2.1 use `'DIRS': [os.path.join(BASE_DIR, 'templates')],` and `import os` at the top of the setting.py file instead of `'DIRS': [BASE_DIR / 'templates'],` 
