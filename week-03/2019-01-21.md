...
### Challenges
* [Apple Trees](https://github.com/golfplatoon/apple-trees)
* [Bowling](https://github.com/golfplatoon/bowling)
...
|Class variable    | **a-z** *or* *_*             | Available anywhere in a specific class (including all instances) (avoid me)
|Global          | **global variable_name**       | Available everywhere, avoid!
|Constant          | **ALL_CAPS**       | Available in the scope of their definition


### Local Variable
- Local variables start with a lowercase letter or an underscore. Underscores are used to declare that a variable is available, but you may not use it
...
```
- You can also assign multiple variables at once. Simply separate the For example:
