...
There are a few differenct CSS modules and properties that allow us to shift elements on the screen in a specific manner. They are Floats, Flexbox, & Grid. One isn't necessarily better than the other but they do function in different ways. 
