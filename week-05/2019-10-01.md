...
## The DOM
Before we can start using Javascript on our front end, we need to understand what the DOM is and how it works. When the bro
wser recieves a webpage (HTML and CSS) it breaks it up into a tree like structure that is called the Document Object Model (DOM).
...
## Challenges
* [Linkedin JS](https://github.com/julietplatoon/linkedin-js)
