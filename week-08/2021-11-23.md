...
Let's walk through a challenge called [Mute Button](https://github.com/papaplatoon/mute-button) together. Through this process we will get a refresher on `state`, learn about React component `props`, and begin using functional components.
