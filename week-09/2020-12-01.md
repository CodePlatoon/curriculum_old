...
- **Synchronous vs Asynchronous code**
  - In Javascript, most code runs synchronous (at the same time). However, if function A's inputs are dependent on function B's output we need to wait for function B to be done executing before envoking function A. This type of code needs to be executed asynchronously.
- **Javascript Promises**
  - Enables you to write asynchronous code.

## Goals
**Core**
- Complete News Site III using the `fetch` api to get outside data.
- Understand the difference between Syncrounous and Asynchronous code
- Understand what a Javascript Promise is.


## Lesson
**News Site III**
Today, we are going to continue on with [news-site-III](https://github.com/mikeplatoon/news-site-III) repo. Just like we saw with News Site I and II, we will be moving much of the code from yesterday's [news-site-II](https://github.com/mikeplatoon/news-site-II).
...
## External Resources
- [Synchronous vs Asynchronous](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Asynchronous/Introducing)
- [Javascript Promises](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise)
- [Fetch API](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch)


## Assignments
* [News Site III](https://github.com/mikeplatoon/news-site-III)
