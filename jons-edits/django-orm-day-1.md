...
Once we have our venv up and running, we can install Django and start a new project. 
...
Next, we need to add that app to our project. 
```python
# school/settings.py
