...
### Challenges
* [Caesar Cipher](https://github.com/golfplatoon/caesar-cipher) in JS/Python
* [Pig Latin](https://github.com/golfplatoon/pig-latin) in JS/Python
* [Bubble Sort](https://github.com/golfplatoon/bubble-sort) in JS/python

### Homework
* Read chapters 5-7 in [POODR](https://github.com/golfplatoon/curriculum/blob/master/week-01/lecture-materials/poodr.pdf). Read chapters 1-4 if you haven't yet - it'll help you with your assessment
