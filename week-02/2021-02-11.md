...
## Assignments
- [Caesar Cipher](https://github.com/novemberplatoon/caesar-cipher) in JS/Python
- [Pig Latin](https://github.com/novemberplatoon/pig-latin) in JS/Python
- [Bubble Sort](https://github.com/novemberplatoon/bubble-sort) in JS/python
