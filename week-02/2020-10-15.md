...
## Assignments
- [Caesar Cipher](https://github.com/mikeplatoon/caesar-cipher) in JS/Python
- [Pig Latin](https://github.com/mikeplatoon/pig-latin) in JS/Python
- [Bubble Sort](https://github.com/mikeplatoon/bubble-sort) in JS/python
