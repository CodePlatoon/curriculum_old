...
* [JS Fundamentals](https://github.com/mikeplatoon/curriculum/blob/master/week-01/lecture-materials/javascript_control_flow.pdf) - control flow, if/else, loops, etc
...
* [Armstrong Numbers](https://github.com/mikeplatoon/armstrong) in JS/Python
* [Sum Pairs](https://github.com/mikeplatoon/sum-pairs) in JS/Python
* [Credit Check](https://github.com/mikeplatoon/credit-check) in JS/Python
* [Anagrams](https://github.com/mikeplatoon/anagrams) in JS and Python
