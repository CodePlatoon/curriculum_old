...
* [JS Fundamentals](https://github.com/limaplatoon/curriculum/blob/master/week-01/lecture-materials/javascript_control_flow.pdf) - control flow, if/else, loops, etc
...
* [Armstrong Numbers](https://github.com/limaplatoon/armstrong) in JS/Python
* [Sum Pairs](https://github.com/limaplatoon/sum-pairs) in JS/Python
* [Credit Check](https://github.com/limaplatoon/credit-check) in JS/Python
* [Anagrams](https://github.com/limaplatoon/anagrams) in JS and Python
