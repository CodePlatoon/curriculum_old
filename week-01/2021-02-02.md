...
* **[JS Fundamentals](https://github.com/novemberplatoon/curriculum/blob/master/week-01/lecture-materials/JSFundamentalsDay1.pdf)**
...
let age = 12
while (age < 21) {
    cosnole.log(`You are not old enough yet - you are only ${age} years old! Come back when you are older.`)
}
...
* [Git Resource](https://github.com/novemberplatoon/git-resource)
* [Wikipedia of Algorithms](http://algorithm.wiki/en/app/)
* [Keyboard Setup to match Mac](https://github.com/novemberplatoon/curriculum/blob/master/week-01/lecture-materials/keyboard-setup.png)
...
### Assignments
* [Roman Numerals](https://github.com/novemberplatoon/roman-numerals) in JS
* [Git Practice](http://learngitbranching.js.org/)
* [Factorial](https://github.com/novemberplatoon/factorial) in JS
* [Fibonacci](https://github.com/novemberplatoon/fibonacci) in JS
* [Linear Search](https://github.com/novemberplatoon/linear-search) in JS
